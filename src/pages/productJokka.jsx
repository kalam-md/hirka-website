...
export default function ProductJokka() {
  const settings = {
    dots: true,
    infinite: true,
    speed: 500,
  ...
  return (
    <>
      <div className="md:p-16 p-10">
        <div className="text-3xl font-nav md:mb-5 md:ml-[10rem]">Jokka SERIES</div>
        <Slider {...settings}>
        ...
        <div className="grid md:grid-cols-2 md:px-[10rem] md:mt-20 mt-10">
          <div className="flex gap-2">
            <img src={img2} alt="" className='md:w-[180px] w-[140px] shadow-md'/>
            <img src={img2} alt="" className='md:w-[180px] w-[140px] shadow-md'/>
          </div>
          <div className="mt-5">
          Keahlian luar biasa: Kombinasi Kulit Ayam Hitam dan Kulit Asli hitam yang tulus dengan lapisan Kain, konstruksi perekat, serta midsole dan outsole berbahan karet.
          </div>
        </div>
        ...
        <div className="grid md:grid-cols-3 gap-3 md:px-[10rem] md:mt-20 mt-10">
          ...
          <div className="flex-col gap-2 my-7 md:my-0">
            <Link to="/product/renjana">
              <img src={img4} alt="" className='md:w-[480px] w-[340px] shadow-md'/>
            </Link>
